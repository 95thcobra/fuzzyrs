...
public class SawmillOperator extends Dialogue {
    ...
    public void start() {
        ...
        sendNPCDialogue(npcId, 9827,
                "Hello. Do you want me to make some planks for you",
    ...
    public void run(final int interfaceId, final int componentId) {
        switch (stage) {
            case -1:
                sendOptionsDialogue("Sawmill operator", "Planks, please.",
                        "What kind of planks can you make?",
                        "Can I buy some housing supplies?", "Nothing, thanks.");
                stage = 1;
                break;
            case 1:
                switch (componentId) {
                    ...
                    case OPTION_2:
                        ...
                        break;
                    case OPTION_3:
                        ShopsManager.openShop(player, 130);
                        end();
                        break;
                    case OPTION_4:
            ...
            case 4:
                sendNPCDialogue(npcId, 9827,
                        "I can make planks from wood, oak, teak and mahogany. I",
            ...
            case 6:
                sendNPCDialogue(npcId, 9827,
                        "Well, come back when you want some. You can't get good",
