...
public class MagicPortal extends Dialogue {
    ...
    public void run(final int interfaceId, final int componentId) {
        ...
        if (stage == 0) {
            if (componentId == 2) {
                ...
                player.useStairs(10584, new WorldTile(3233, 9315, 0), 2, 3,
            ...
            if (componentId == 3) {
                player.getPackets().sendGameMessage("You enter the portal...");
                player.useStairs(10584, new WorldTile(2152, 3868, 0), 2, 3,
                        "..and are transported to an altar.");
    ...
    @Override
    public void start() {
        sendOptionsDialogue("Select an Option", "Ancient Magic Altar",
                "Lunar Magic Altar", "Never Mind");
    }
