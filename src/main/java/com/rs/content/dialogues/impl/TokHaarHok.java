        ...
        switch (type) {
                ...
                switch (stage) {
                    ...
                    case 1:
                        ...
                        sendOptionsDialogue(SEND_DEFAULT_OPTIONS_TITLE,
                                "No, let's just fight.",
                                "What do I get if I beat you?", "What are the rules?");
                        break;
                    case 2:
                        switch (componentId) {
                            case OPTION_1:
            ...
            case 2:
                switch (stage) {
                    case -1:
                        ...
                        final WorldTile lookTo = fightKiln.getWorldTile(37, 50);
                        player.getPackets().sendCameraLook(
                                Cutscene.getX(player, lookTo.getX()),
                                Cutscene.getY(player, lookTo.getY()), 1000);
                        final WorldTile posTile = fightKiln.getWorldTile(37, 45);
            ...
            case 5:
                switch (stage) {
                    case -1:
                        stage = 0;
                        sendNPCDialogue(npcId, 9827,
                                "	Take this cape as a symbol of our -");
                        break;
                    case 0:
                        stage = 1;
            ...
            case 6:
                switch (stage) {
                    ...
                    case 0:
                        stage = 1;
                        sendOptionsDialogue("Choose your reward:", "The TokHaar-Kal",
                                "An uncut onyx");
                        break;
                    case 1:
                        if (componentId == OPTION_1) {
                            ...
                            sendNPCDialogue(
                                    npcId,
                                    9827,
                                    "Onyx is a precious and rare gem that can be crafted into one of several powerful objects, including the coveted Amulet of Fury.");
                        }
                        break;
                    case 2:
                    case 3:
                        stage = (byte) (stage == 2 ? 4 : 5);
                        sendOptionsDialogue("Accept the "
                                        + (stage == 4 ? "TokHaar-Kal" : "uncut onyx") + "?",
                                "Yes.", "No.");
                        break;
                    case 4:
                    case 5:
                        if (componentId == OPTION_1) {
                            player.getTemporaryAttributtes().put("FightKilnReward",
                                    stage == 4 ? 0 : 1);
                            stage = 6;
                            sendNPCDialogue(npcId, 9827,
                                    "Let us test our strength again...soon...");
                        } else {
                            stage = 1;
                    ...
                    case 6:
                        stage = 7;
                        sendNPCDialogue(npcId, 9827,
                                "Now,leave...before the lava consumes you.");
                        break;
                    case 7:
                        end();
                        break;
