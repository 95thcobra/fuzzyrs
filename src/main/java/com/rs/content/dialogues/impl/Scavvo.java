...
public class Scavvo extends Dialogue {
    ...
    public void start() {
        ...
        sendNPCDialogue(npcId, 9827,
                "'Ello, matey! D'ya wanna buy some exciting new toys?");
    }
        ...
        switch (stage) {
            case -1:
                ...
                sendOptionsDialogue(SEND_DEFAULT_OPTIONS_TITLE,
                        "No - toys are for kids.", "Let's have a look, then.",
            ...
            case 0:
                switch (componentId) {
                    case 1:
                        ...
                        break;
                    case 2:
                        ShopsManager.openShop(player, 12);
                        end();
                        break;
                    case 3:
                        stage = 1;
            ...
            case 2:
                ...
                sendNPCDialogue(
                        npcId,
                        9827,
                        "Oh, you have to complete a special quest in order to wear",
