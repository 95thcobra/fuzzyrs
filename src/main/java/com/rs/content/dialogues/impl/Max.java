    ...
    public void run(int interfaceId, int componentId) {
        if (stage == 0) {
            ...
            sendOptionsDialogue("What would you like to say?",
                    "Who are you?", "Nice cape you have there...", "Do you have any other capes?", "Nothing, thanks.");
        } else if (stage == 1) {
            ...
            sendEntityDialogue(
                    ...
                    new String[]{
                            NPCDefinitions.getNPCDefinitions(npcId).name,
                            "Thanks. I have faith in you, " + player.getUsername() + " - one day you'll be here and I'll sell you one for yourself!"},
                    IS_NPC, npcId, 9827);
            ...
            if (componentId == OPTION_1) {
                if (player.getInventory().getFreeSlots() < 2) {
                    ...
                    stage = 50;
                    /*sendEntityDialogue(IS_ITEM, new String[]{
                            ItemDefinitions.getItemDefinitions(20767).getName(),
                            "Max hands over the max cape."}, IS_ITEM, 20767, -1);*/
                    ...
                    /*if (!player.boughtMaxCape) {
                        ...
                        World.sendWorldMessage("<img=6><col=ff0000>News: " + player.getDisplayName()
                                + " has just achieved Max cape.", false);
                    }*/
                } else {
                    stage = 50;
                    sendEntityDialogue(
                            ...
                            new String[]{
                                    NPCDefinitions.getNPCDefinitions(npcId).name,
                                    "I'm afraid you don't have enough enough money to do that."},
                            IS_NPC, npcId, 9827);
                }
            } else if (componentId == OPTION_2) {
                stage = 50;
            ...
            sendEntityDialogue(
                    ...
                    new String[]{
                            NPCDefinitions.getNPCDefinitions(npcId).name,
                            "I do have capes for people who achieved 99 in a skill."},
                    IS_NPC, npcId, 9827);
        } else if (stage == 41) {
            stage = 50;
            player.stopAll();
