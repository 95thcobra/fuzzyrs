...
public final class MiningGuildDwarf extends Dialogue {
    ...
    public static int getClosestDwarfID(final Player player) {
        int npcId = 3295;
        int distance = -1;
        for (final int regionId : player.getMapRegionsIds()) {
            ...
            if (npcsIndexes != null) {
                for (final int npcIndex : npcsIndexes) {
                    ...
                    final int newDistance = Utils.getDistance(player, npc);
    ...
    public void run(final int interfaceId, final int componentId) {
        switch (stage) {
            ...
            case 0:
                ...
                break;
            case 1:
                stage = (byte) (player.getSkills().getLevelForXp(Skills.MINING) < 60 ? 2
                        : 4);
                sendEntityDialogue(
                        SEND_4_TEXT_CHAT,
                        new String[]{
            ...
            case 3:
                ...
                sendEntityDialogue(
                        ...
                        new String[]{
                                ...
                                "Can I help you with anything else?"}, IS_NPC,
                        npcId, 9827);
                break;
            case 4:
                stage = 5;
                sendEntityDialogue(
                        ...
                        new String[]{
                                ...
                                "It's a good thing I have level "
            ...
            case 8:
                ...
                sendEntityDialogue(
                        ...
                        new String[]{
                                ...
                                "goods and services."}, IS_NPC, npcId, 9827);
                break;
            case 9:
                stage = 10;
                sendEntityDialogue(SEND_2_TEXT_CHAT,
            ...
            case 11:
                ...
                sendEntityDialogue(
                        ...
                        new String[]{
                                ...
                                "else?"}, IS_NPC, npcId, 9827);
                break;
            case 12:
                stage = 13;
                sendOptionsDialogue("What would you like to say?",
                        "What have you got in the guild?", "No thanks, I'm fine.");
                break;
            case 13:
                if (componentId == 1) {
                    stage = 1;
            ...
            case 15:
                ...
                sendEntityDialogue(SEND_1_TEXT_CHAT,
                        new String[]{
                                NPCDefinitions.getNPCDefinitions(npcId).name,
                                "can help you with?"}, IS_NPC, npcId, 9827);
                break;
            case 16:
                stage = 17;
            ...
            case 17:
                if (componentId == 1) {
                    ...
                    sendEntityDialogue(SEND_1_TEXT_CHAT, new String[]{
                                    NPCDefinitions.getNPCDefinitions(npcId).name,
                                    "So what can I help you with, then?"}, IS_NPC, npcId,
                            9827);
                } else {
                    stage = 18;
                    sendEntityDialogue(SEND_1_TEXT_CHAT,
            ...
            case 18:
                ...
                sendEntityDialogue(SEND_1_TEXT_CHAT,
                        new String[]{
                                NPCDefinitions.getNPCDefinitions(npcId).name,
                                "Okay, bye then."}, IS_NPC, npcId, 9827);
                break;
            default:
                end();
                break;
