...
public class MusicianD extends Dialogue {
    ...
    //A long preformatted string because the interface only takes one CID :)
    static String longString = "You may start running by clicking once on the Run button, which is the<br>running man icon at the top-right of the minimap. Clicking the Run button<br>a second time will switch you back to walking. It tells you how much run<br>energy you currently have.";
    int npcId;
        ...
        switch (stage) {
            case -1:
                ...
                switch (componentId) {
                    case OPTION_1:
                        stage = 1;
                        sendNPCDialogue(npcId, 9845, "Me? I'm a musician! Let me help you relax: sit down, rest<br>",
                    ...
                    case OPTION_3:
                        stage = 20;
                        sendNPCDialogue(npcId, 9845, "Running? Of course! Not that I do much running, I prefer<br>",
                                "to saunter. But you adventuring types always seem to be<br>",
                                "in a rush, zipping hither and thither.");
                        break;
                    case OPTION_4:
                        stage = 126;
                        sendNPCDialogue(npcId, 9845, "Well, don't forget to have a rest every now and again.");
                        break;
                    default:
                        stage = 126;
                        break;
            ...
            case 1:
                stage = 2;
                sendNPCDialogue(npcId, 9845, "Know music has curative properties? Music stimulates the<br>",
            ...
            case 3:
                stage = 4;
                sendNPCDialogue(npcId, 9845, "I was told by a travelling medical practitioner, selling oil<br>",
            ...
            case 4:
                stage = 5;
                sendNPCDialogue(npcId, 9845, "pancea, if you will. Ah, the power of music.");
                break;
            case 5:
                stage = 6;
                sendPlayerDialogue(9827, "So, just listening to some music will cure me of all my ills?");
                break;
            case 6:
                stage = 7;
                sendNPCDialogue(npcId, 9845, "Well, not quite. Poison, lack of faith and dismembered<br>",
            ...
            case 8:
                stage = 127;
                sendNPCDialogue(npcId, 9845, "Oh, no! My reward is the pleasure I bring to the masses.<br>",
            ...
            case 9:
                switch (componentId) {
                    case OPTION_1:
                        stage = 10;
                        sendNPCDialogue(npcId, 9845, "Have you ever been on a long journey, and simply wanted<br>",
                                "to have a rest? When you're running from city to city,<br>",
                                "it's so easy to run out of breath, don't you find?");
                        break;
                    case OPTION_2:
                        stage = 17;
                        sendNPCDialogue(npcId, 9845, "The effects of resting are enhanced by music. Your run<br>",
                                "energy will recharge many times the normal rate, and<br>",
                                "your life points three times as fast.");
                        break;
                    case OPTION_3:
                        stage = 18;
                        sendNPCDialogue(npcId, 9845, "Certainly. You can rest anywhere, simply choose the Rest<br>",
            ...
            case 11:
                stage = 12;
                sendNPCDialogue(npcId, 9845, "Well, you may rest anywhere, simply choose the Rest<br>",
                        "option on the run buttons.");
                break;
            case 12:
                stage = 13;
                sendNPCDialogue(npcId, 9845, "When you rest, you will sit on the floor. When you are<br>",
            ...
            case 13:
                stage = 14;
                sendNPCDialogue(npcId, 9845, "Of course, you can't do anything else while you're resting,<br>",
                        "other than talk.");
                break;
            case 14:
                stage = 15;
            ...
            case 15:
                stage = 16;
                sendNPCDialogue(npcId, 9845, "Well, you wouldn't be resting, now would you?");
                break;
            case 16:
                stage = 127;
                sendNPCDialogue(npcId, 9845, "Also, you should know that resting by a musician, has a<br>",
                        "similar effect but the benefits are greater.");
                break;
            case 17:
                stage = 127;
                sendNPCDialogue(npcId, 9845, "Simply sit down and rest as you would normally, nice and<br>",
            ...
            case 18:
                stage = 19;
                sendNPCDialogue(npcId, 9845, "Resting anywhere will replenish your run energy more<br>",
                        "quickly than normal, your life points will replenish twice<br>",
                        "as fast as well!");
                break;
            case 19:
                stage = 127;
                sendNPCDialogue(npcId, 9845, "Resting by a musician will replenish your run energy many<br>",
            ...
            case 21:
                stage = 22;
                sendNPCDialogue(npcId, 9845, "Running is the simplest way to get somewhere quickly.<br>",
            ...
            case 22:
                stage = 23;
                sendNPCDialogue(npcId, 9845, "to fight, you can always run away.");
                break;
            case 23:
                stage = 24;
            ...
            case 24:
                stage = 25;
                sendNPCDialogue(npcId, 9845, "No, eventually you'll get tired. When that happens you will<br>",
            ...
            case 25:
                stage = 26;
                sendNPCDialogue(npcId, 9845, "resting, or more slowly whilst walking.");
                break;
            case 26:
                stage = 127;
