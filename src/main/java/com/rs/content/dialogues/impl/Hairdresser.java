...
public class Hairdresser extends Dialogue {
    ...
    public void start() {
        ...
        sendNPCDialogue(npcId, 9827, "Good afternoon, "
                + (player.getAppearance().isMale() ? "sir" : "lady")
            ...
            case 2:
                if (player.getEquipment().getHatId() != -1) {
                    ...
                    sendNPCDialogue(
                            npcId,
                            9827,
                            "Of course; but I can't see your head at the moment. Please remove your headgear first.");
                } else if (player.getEquipment().getWeaponId() != -1
                    ...
                    sendNPCDialogue(
                            npcId,
                            9827,
                            "Certainly, sir. We have a special offer at the moment: all shaves and chaircuts are free!");
                }
                break;
            case 3:
                stage = 4;
                sendNPCDialogue(
                        npcId,
                        9827,
                        "Please select the hairstyle, beard and colour you would like from this brochure.");
                break;
            case 4:
