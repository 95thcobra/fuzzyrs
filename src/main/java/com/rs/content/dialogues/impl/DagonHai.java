...
public class DagonHai extends Dialogue {
    ...
    public void start() {
        ...
        final Player player = (Player) parameters[1];
        ...
        if (stage == 1) {
            ...
            sendEntityDialogue(
                    ...
                    IS_NPC, npcId, 9843); // TODO Need correct Animation ID.
        }
    }
    ...
    public void run(final int interfaceId, final int componentId) {
        if (stage == -1) {
            ...
            sendPlayerDialogue(9827,
                    "What th-? This power again! It must be Zamorak! I",
                    "can't fight something this strong! I better loot what I ",
