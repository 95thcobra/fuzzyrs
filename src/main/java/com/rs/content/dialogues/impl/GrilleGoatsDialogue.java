...
public class GrilleGoatsDialogue extends Dialogue {
    ...
    @Override
    public void start() {
        sendNPCDialogue(GRILLEGOATS, 9827,
                "Tee hee! You have never milked a cow before, have you?");
        stage = -1;
    }
            ...
            case 1:
                sendNPCDialogue(GRILLEGOATS, 9827,
                        "Because you're spilling milk all over the floor. What a waste! "
                                + "You need something to hold the milk.");
                break;
            case 2:
                sendPlayerDialogue(9827,
                        "Derp. Ah, yes, I really should have guessed that one, shouldn't I?");
                break;
            case 3:
                sendNPCDialogue(GRILLEGOATS, 9827,
                        "You're from the city, arent you? Try it again with an empty bucket.");
                break;
            case 4:
