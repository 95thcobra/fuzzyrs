        ...
        switch (stage) {
            case -1:
                ...
                sendOptionsDialogue(SEND_DEFAULT_OPTIONS_TITLE,
                        "What is this place?", "What did you call me?",
                        "No I'm fine thanks.");
                break;
            case 0:
                switch (componentId) {
            ...
            case 1:
                ...
                sendNPCDialogue(
                        npcId,
                        9827,
                        "This is the Fight Cave, ThzHaar-Xil made it for practice but many JalYt come here to fight, too. Just enter the cave and make sure you're prepared.");
                break;
            case 2:
                stage = 3;
                sendOptionsDialogue(SEND_DEFAULT_OPTIONS_TITLE,
            ...
            case 4:
                stage = 5;
                sendNPCDialogue(npcId, 9827,
                        "Rules? Survival is the only rule in there.");
                break;
            case 5:
                stage = 6;
                sendOptionsDialogue(SEND_DEFAULT_OPTIONS_TITLE,
            ...
            case 7:
                stage = 8;
                sendNPCDialogue(npcId, 9827,
                        "You ask a lot questions.<br>Might give you TokKul if you last long enough.");
                break;
            case 8:
                stage = 9;
