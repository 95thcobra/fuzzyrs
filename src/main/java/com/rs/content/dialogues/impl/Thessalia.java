...
public class Thessalia extends Dialogue {
    ...
    public void start() {
        ...
        sendNPCDialogue(npcId, 9827, "Would you like to buy any fine clothes?");
    }
        ...
        switch (stage) {
            ...
            case 8:
                ...
                sendOptionsDialogue(SEND_DEFAULT_OPTIONS_TITLE,
                        ...
                        "I'd just like to buy some cloths.", "No, thank you.");
                break;
            case 9:
            ...
            case 10:
                if (player.getEquipment().wearingArmour()) {
                    ...
                    sendNPCDialogue(
                            npcId,
                            9827,
                            "You can't try them on while wearing armour. Take it off and then speak to me again.");
                } else {
                    stage = 11;
                    sendNPCDialogue(
                            npcId,
                            9827,
                            "Wonderful. Feel free to try on some items and see if there's anything you would like.");
                }
                break;
            case 11:
                stage = 12;
