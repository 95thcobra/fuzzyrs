...
import com.rs.player.content.AncientEffigies;
...
public class AncientEffigiesD extends Dialogue {
    ...
    public void start() {
        ...
        sendDialogue("As you inspect the ancient effigy, you begin to feel a",
                "strange sensation of the relic searching your mind,",
                "drawing on your knowledge.");
        final int random = Utils.getRandom(7);
    ...
    public void run(final int interfaceId, final int componentId) {
        if (stage == -1) {
            sendDialogue("Images from your experiences of "
            ...
            sendOptionsDialogue("Which images do you wish to focus on?",
                    Skills.SKILL_NAME[skill1], Skills.SKILL_NAME[skill2]);
            stage = 1;
            ...
            if (player.getSkills().getLevel(
                ...
                sendDialogue("As you focus on your memories, you can almost hear a",
            ...
            // player.getSkills().addXpValue((Integer)
            ...
            sendDialogue("The ancient effigy glows briefly; it seems changed",
                    "somehow and no longer responds to the same memories",
                    "as before.");
            stage = 3;
        } else if (stage == 3) {
            sendDialogue("A sudden bolt of inspiration flashes through your mind,",
