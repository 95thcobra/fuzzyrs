...
import com.rs.content.actions.skills.smithing.Smelting;
import com.rs.content.actions.skills.smithing.Smelting.SmeltingBar;
...
public class SmeltingD extends Dialogue {
    ...
    public void start() {
        ...
        final int[] ids = new int[SmeltingBar.values().length];
                ...
                .sendSkillsDialogue(
                        ...
                        28, ids, new ItemNameFilter() {
                            ...
                            public String rename(String name) {
                                final SmeltingBar bar = SmeltingBar.values()[count++];
                                if (player.getSkills()
