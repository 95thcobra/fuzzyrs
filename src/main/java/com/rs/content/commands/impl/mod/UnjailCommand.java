...
import com.rs.content.staff.actions.impl.UnJailAction;
import com.rs.player.Player;

/**
 * @author FuzzyAvacado
 */
@CommandInfo(name = "unjail", rank = PlayerRank.MOD)
public class UnjailCommand implements Command {
    ...
    public void handle(Player player, String[] cmd) {
        ...
        StaffActionManager.getStaffAction(UnJailAction.class).handle(player, name);
    }
}
