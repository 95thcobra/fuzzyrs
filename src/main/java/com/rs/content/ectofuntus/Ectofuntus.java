...
public class Ectofuntus {
    ...
    public static void handleWorship(Player player) {
        ...
        for (Item item : player.getInventory().getItems().getItems()) {
            ...
            if (bone != null) {
                ...
                if (boneData == null) {
                    player.getPackets().sendGameMessage("Error bone not added.. Please post the bone you tried to add on the forums.");
                    return;
                }
                ...
                player.getSkills().addXp(Skills.PRAYER, boneData.getExperience() * 4);
    ...
    public static boolean handleItemOnObject(Player player, int itemId, int objectId) {
        ...
        if (itemId == EMPTY_BUCKET && objectDefs.name.equals("Pool of Slime")) {
