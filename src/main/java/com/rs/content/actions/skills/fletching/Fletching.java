package com.rs.content.actions.skills.fletching;
...
public class Fletching extends Action {
    ...
    public Fletching(final Fletch fletch, final int option, final int ticks) {
        this.fletch = fletch;
        this.option = option;
        this.ticks = ticks;
    }
    ...
    public static boolean maxMakeQuantityTen(final Fletch fletch) {
    ...
    public static Fletch isFletching(final Item first, final Item second) {
    ...
    public boolean process(final Player player) {
        ...
        if (player.getSkills().getLevel(Skills.FLETCHING) < fletch.getLevel()[option]) {
            player.getDialogueManager().startDialogue(SimpleMessage.class, "You need a level of " + Arrays.toString(fletch.getLevel()) + " to fletch this.");
            return false;
        }
        return true;
    }
    ...
    public enum Fletch {
        ...
        static {
            for (final Fletch fletch : Fletch.values()) {
        ...
        Fletch(final int id, final int selected, final int[] product,
               final int level[], final double[] xp, final Animation anim) {
            this.id = id;
        ...
        public static Fletch forId(final int id) {
