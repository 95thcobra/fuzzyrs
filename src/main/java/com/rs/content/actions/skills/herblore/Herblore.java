...
public class Herblore extends Action {
	...
	public Herblore(final Item node, final Item otherNode, final int amount) {
	...
	public static int isHerbloreSkill(Item first, Item other) {
		...
		if (ingredient != null) {
			final int slot = ingredient.getSlot(other.getId());
	...
	public boolean process(final Player player) {
		...
		return !(!player.getInventory().containsItem(node.getId(), node.getAmount())
	...
	public enum Ingredients {
		...
		static {
			for (final Ingredients ingredient : Ingredients.values()) {
		...
		Ingredients(final int itemId, final short[] otherItems,
					final short[] rewards, final byte[] levels,
		...
		public static Ingredients forId(final int itemId) {
		...
		public byte getSlot(final int itemId) {
	...
	public enum RawIngredient {
		...
		static {
			for (final RawIngredient rawIngredient : RawIngredient.values()) {
		...
		RawIngredient(final int rawId, final Item crushedItem) {
			this.rawId = (short) rawId;
			this.crushedItem = crushedItem;
		}

		public static RawIngredient forId(final int itemId) {
