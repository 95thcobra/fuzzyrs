...
public class BarbarianOutpostAgility {
	...
	public static void runUpWall(final Player player, final WorldObject object) {
	...
	public static void climbObstacleNet(final Player player,
			final WorldObject object) {
	...
	public static void climbOverCrumblingWall(final Player player,
		...
		WorldTasksManager.schedule(new WorldTask() {
			...
			public void run() {
				...
				final int stage = getStage(player);
				if (stage == 3) {
					setStage(player, 4);
				} else if (stage == 4) {
					removeStage(player);
	...
	public static void removeStage(final Player player) {
		player.getTemporaryAttributtes().remove("BarbarianOutpostCourse");
	}

	public static void setStage(final Player player, final int stage) {
