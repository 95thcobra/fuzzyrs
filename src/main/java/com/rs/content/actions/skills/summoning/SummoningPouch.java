...
public enum SummoningPouch {
    ...
    static {
        for (final SummoningPouch pouch : SummoningPouch.values()) {
    ...
    SummoningPouch(final int pouchId, final int levelRequired,
                   final double createExperience, final int npcId,
                   final double summonExperience, final int summonCost,
                   final Item... items) {
    ...
    public static SummoningPouch get(final int pouchId) {
