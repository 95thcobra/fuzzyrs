...
public enum PickPocketableNPC {
    ...
    MAN(new short[]{1, 2, 3, 4, 5, 6, 16, 24, 170}, new byte[]{1, 11, 21,
            31}, new byte[]{1, 1, 11, 21}, 8.0, 4, 10, new Item(995, 3)),

    /**
     * The regular farmer npcs.
     */
    FARMER(new short[]{7, 1757, 1758, 1760}, new byte[]{10, 20, 30, 40},
            new byte[]{1, 10, 20, 30}, 14.5, 4, 10, new Item(995, 9),
            new Item(5318, 1)),
    ...
    FEMALE_HAM(new short[]{1715}, new byte[]{15, 25, 35, 45}, new byte[]{
            1, 15, 25, 35}, 18.5, 3, 10, new Item(995, 12), new Item(590),
    ...
    MALE_HAM(new short[]{1714, 1716}, new byte[]{20, 30, 40, 50},
            new byte[]{1, 20, 30, 40}, 22.5, 3, 20, new Item(995, 12),
    ...
    HAM_GUARD(new short[]{1710, 1711, 1712}, new byte[]{20, 30, 40, 50},
            new byte[]{1, 20, 30, 40}, 22.5, 3, 30, new Item(995, 12),
            new Item(590), new Item(1621), new Item(1623), new Item(1625),
            new Item(1269), new Item(321), new Item(2138), new Item(4298),
            new Item(4300), new Item(4302), new Item(4304), new Item(4306),
            new Item(4308), new Item(4310), new Item(1267), new Item(1353),
    ...
    WARRIOR(new short[]{15, 18}, new byte[]{25, 35, 45, 55}, new byte[]{
            1, 25, 35, 45}, 26, 5, 20, new Item(995, 18)),

    /**
     * The rogues.
     */
    ROGUE(new short[]{187, 2267, 2268, 2269, 8122}, new byte[]{32, 42, 52,
            62}, new byte[]{1, 32, 42, 52}, 35.5, 4, 20, new Item(995, 25),
     ...
     * City guards.
     */
    ISLAND(new short[]{13212}, new byte[]{40, 50, 60, 70}, new byte[]{
            1, 40, 50, 60}, 46.5, 4, 20, new Item(995, 35000)),

    QUEST(new short[]{21}, new byte[]{40, 50, 60, 70}, new byte[]{1,
            40, 50, 60}, 46.5, 4, 20, new Item(275, 1)),

    GUARD(new short[]{32, 206, 296, 297, 298, 299, 344, 345, 346, 368, 678,
            812}, new byte[]{40, 50, 60, 70}, new byte[]{1, 40, 50, 60},
            46.5, 4, 20, new Item(995, 30)),

    /**
     * Fremennik citizen. TODO: correct npc ids.
     */
    FREMENNIK_CITIZEN(new short[]{2462}, new byte[]{45, 55, 65, 75},
            new byte[]{1, 45, 55, 65}, 65, 4, 20, new Item(995, 40)),

    /**
     * A knight of ardougne.
     */
    ARDOUGNE_KNIGHT(new short[]{23, 26}, new byte[]{55, 65, 75, 85},
            new byte[]{1, 55, 65, 75}, 84.3, 4, 30, new Item(995, 50)),

    /**
     * A menaphite thug.
     */
    MENAPHITE_THUG(new short[]{1905}, new byte[]{65, 75, 85, 95},
            new byte[]{1, 65, 75, 85}, 137.5, 4, 50, new Item(995, 60)),

    /**
     * A paladin.
     */
    PALADIN(new short[]{20, 2256}, new byte[]{70, 80, 90, 100},
            new byte[]{1, 70, 80, 90}, 151.75, 4, 30, new Item(995, 80),
            new Item(562, 2)),

    /**
     * A monkey knife fighter.
     */
    MONKEY_KNIFE_FIGHTER(new short[]{13195, 13213}, new byte[]{70, 127,
            127, 127}, new byte[]{1, 1, 1, 1}, 150, 4, 10,
            new Item(995, 1), new Item(995, 50), new Item(869, 4), new Item(
            874, 2), new Item(379), new Item(1331), new Item(1333),
            new Item(4587)),
    ...
    GNOME(new short[]{66, 67, 68, 168, 169, 2249, 2250, 2251, 2371, 2649,
            ...
            75, 85, 95}, 198.5, 4, 10, new Item(995, 300), new Item(557),
            new Item(444), new Item(569), new Item(2150), new Item(2162)),

    /**
     * Heroes.
     */
    HERO(new short[]{10000}, new byte[]{80, 90, 100, 110}, new byte[]{
            1, 80, 90, 100}, 275, 5, 40, new Item(995, 200),
            new Item(995, 300), new Item(560, 2), new Item(565), new Item(569),
            new Item(1601), new Item(444), new Item(1993)),
     ...
     */
    static {
        for (final PickPocketableNPC data : PickPocketableNPC.values()) {
            for (final short id : data.npcIds) {
                NPCS.put(id, data);
            }
        }
    }
     ...
     *
     * @param npcIds        The array containing all the npc ids of the npcs using this
     *                      pickpocket data.
     * @param thievingLevel The thieving levels required (slot 0 = normal loot, 1 =
     ...
     * @param stunTime      The stun time (per sec).
     * @param stunDamage    The stun damage to deal when stunned.
     * @param loot          The possible loot.
     */
    PickPocketableNPC(final short[] npcIds, final byte[] thievingLevel,
                      final byte[] agilityLevel, final double experience,
                      final int stunTime, final int stunDamage, final Item... loot) {
        this.npcIds = npcIds;
     ...
     */
    public static PickPocketableNPC get(final int id) {
