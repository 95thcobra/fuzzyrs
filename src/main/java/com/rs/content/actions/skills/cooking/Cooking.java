package com.rs.content.actions.skills.cooking;
...
public class Cooking extends Action {
    ...
    public Cooking(final WorldObject object, final Item item, final int amount) {
        this.amount = amount;
        this.item = item;
        this.object = object;
    }

    public static Cookables isCookingSkill(final Item item) {
    ...
    private boolean isBurned(final Cookables cook, final Player player) {
        final int level = player.getSkills().getLevel(Skills.COOKING);
    ...
    public int processWithDelay(final Player player) {
        ...
        if (player.SamuraiCooking == true) {
            ...
            player.setNextAnimation(object.getDefinitions().name
                    .contains("fire") ? FIRE_COOKING : RANGE_COOKING);
        }
    ...
    public enum Cookables {
        ...
        static {
            for (final Cookables ingredient : Cookables.values()) {
        ...
        Cookables(final Item raw, final int lvl, final int burningLvl,
                  final int exp, final Item burnt, final Item total,
                  final boolean spitRoast, final boolean fireOnly) {
            this.raw = raw;
            this.lvl = lvl;
        ...
        public static Cookables forId(final short itemId) {
