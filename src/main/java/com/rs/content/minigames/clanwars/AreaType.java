...
public enum AreaType {
	 ...
	 */
	CLASSIC_AREA(new WorldTile(2752, 5888, 0), new WorldTile(2815, 6015, 0),
			35, 10, -36, -9, 56, 58, -7, -58),

	/**
	 * The plateau area type.
	 */
	PLATEAU(new WorldTile(2831, 5888, 0), new WorldTile(2928, 5951, 0), 59, 12,
			-38, -10, 27, 21, -70, -20),

	/**
	 * The forsaken quarry area type.
	 */
	FORSAKEN_QUARRY(new WorldTile(2880, 5504, 0), new WorldTile(2943, 5567, 0),
			11, 11, -10, -10, 28, 32, -28, -30),

	/**
	 * The blasted forest area type.
	 */
	BLASTED_FOREST(new WorldTile(2880, 5632, 0), new WorldTile(2942, 5695, 0),
			12, 9, -12, -9, 13, 29, -13, -28),

	/**
	 * The turrets area type.
	 */
	TURRETS(new WorldTile(2689, 5505, 0), new WorldTile(2750, 5630, 0), 42, 7,
			-40, -5, 2, 3, 0, -1);
	 ...
	 *            The second team's y death offset.
	 */
	AreaType(final WorldTile southWestTile,
			 final WorldTile northEastTile, final int firstSpawnOffsetX,
			 final int firstSpawnOffsetY, final int secondSpawnOffsetX,
			 final int secondSpawnOffsetY, final int firstDeathOffsetX,
			 final int firstDeathOffsetY, final int secondDeathOffsetX,
			 final int secondDeathOffsetY) {
