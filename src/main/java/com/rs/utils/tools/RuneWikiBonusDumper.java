        ...
        try {
            ...
            for (String line : page.getLines()) {
                ...
                if (bonusId == 0 || bonusId == 5) {
                    final String replace = "<td colspan=\"2\" width=\"30\" align=\"center\">";
                    if (line.startsWith(replace)) {
                        line = line.replace(replace, "").replaceAll(" ", "")
                                .replace("+", "").replace("<br/>", "");
                        final int bonus = Integer.valueOf(line);
                    ...
                    final String replace = "</td><td colspan=\"2\" width=\"30\" align=\"center\">";
                    if (line.startsWith(replace)) {
                        line = line.replace(replace, "").replaceAll(" ", "")
                    ...
                    final String replace = "<td colspan=\"4\" width=\"60\" align=\"center\">";
                    if (line.startsWith(replace)) {
                        line = line.replace(replace, "").replaceAll(" ", "")
                                .replace("%", "").replace(".0", "");
                        final int bonus = Integer.valueOf(line);
                    ...
                    final String replace = "</td><td colspan=\"4\" width=\"60\" align=\"center\">";
                    if (line.startsWith(replace)) {
                        line = line.replace(replace, "").replaceAll(" ", "")
                                .replace("%", "").replace(".0", "");
                        final int bonus = Integer.valueOf(line);
                    ...
                    final String replace = "<td colspan=\"3\" width=\"45\" align=\"center\">";
                    if (line.startsWith(replace)) {
                        line = line.replace(replace, "").replaceAll(" ", "")
                                .replace("+", "").replace(".0", "")
                                .replace(".1", "").replace(".5", "");
                        final int bonus = (Double.valueOf(line)).intValue();
                        // System.out.println(bonus);
                        bonuses[bonusId++] = bonus;
                        continue;
                    }
                } else if (bonusId >= 15 && bonusId <= 17) {
                    final String replace = "</td><td colspan=\"3\" width=\"45\" align=\"center\">";
                    if (line.startsWith(replace)) {
                        line = line.replace(replace, "").replaceAll(" ", "")
                                .replace("%", "").replace("+", "")
