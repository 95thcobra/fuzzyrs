...
import com.rs.core.net.handlers.inventory.ItemOnItemHandler;
import com.rs.core.net.handlers.inventory.ItemOnNpcHandler;
import com.rs.core.net.handlers.inventory.ItemOnPlayerHandler;
import com.rs.core.net.handlers.npc.NPCHandler;
    ...
    public void processPackets(final int packetId, final InputStream stream,
        ...
        if (packetId == PING_PACKET) {
            ...
            if (player.getInterfaceManager().containsInterface(1108)) {
                ...
                if (!DisplayNamesFileManager.setDisplayName(player, value)) {
                    player.getPackets().sendGameMessage(
            ...
            if (message.startsWith("::") || message.startsWith(";;")) {
                ...
                // message
                CommandManager.processCommand(player, message.replace("::", "")
                        .replace(";;", ""), false, false);
                return;
            }
            if (message.contains("0hdr2ufufl9ljlzlyla")
