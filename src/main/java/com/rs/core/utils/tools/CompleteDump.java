...
import com.rs.core.utils.tools.WikiEqupSlotDumper.EquipSlot;
...
public class CompleteDump {
    ...
    public static void addItemsByHand() {
        ...
        slots.add(new EquipSlot(28000, SlotType.TWO_HANDED));
    ...
    public static void main(final String[] args) {
        ...
        try {
            ...
            while (buffer.hasRemaining()) {
                ...
                final EquipSlot ep = new EquipSlot(id,
                        SlotType.valueOf(new String(data)));
