...
public final class Cache {
	...
	public static byte[] generateUkeysFile() {
		...
		final OutputStream hashStream = new OutputStream(65);
		...
		hash = Utils.cryptRSA(hash, GameConstants.GRAB_SERVER_PRIVATE_EXPONENT, GameConstants.GRAB_SERVER_MODULUS);
