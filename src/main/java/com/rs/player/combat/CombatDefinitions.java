...
public final class CombatDefinitions implements Serializable {
	...
	public static final int ABSORB_MELEE_BONUS = 11, ABSORB_RANGE_BONUS = 13,
			ABSORB_MAGE_BONUS = 12;
	...
	public static int getMeleeDefenceBonus(final int bonusId) {
	...
	public static int getMeleeBonusStyle(final int weaponId,
	...
	public static int getXpStyle(final int weaponId, final int attackStyle) {
	...
	public int getSpellId() {
		final Integer tempCastSpell = (Integer) player
				.getTemporaryAttributtes().get("tempCastSpell");
	...
	public void setAutoCastSpell(final int id) {
	...
	public void setSortSpellBook(final int sortId) {
	...
	public void refreshBonuses() {
		...
		for (final Item item : player.getEquipment().getItems().getItems()) {
			...
			final int[] bonuses = ItemBonuses.getItemBonuses(item.getId());
			if (bonuses == null) {
				continue;
			}
	...
	public void desecreaseSpecialAttack(final int ammount) {
	...
	public void setAttackStyle(int style) {
		...
		final String name = weaponId == -1 ? "" : ItemDefinitions
				.getItemDefinitions(weaponId).getName().toLowerCase();
	...
	public void setAutoRelatie(final boolean autoRelatie) {
