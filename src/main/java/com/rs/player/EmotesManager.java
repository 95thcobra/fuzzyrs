...
public final class EmotesManager implements Serializable {
	...
	public EmotesManager() {
		...
		for (int emoteId = 2; emoteId < 121; emoteId++) {
			unlockedEmotes.add(emoteId);
		}
		unlockedEmotes.add(39); // skillcape
	}

	public static int getId(final int id, final int packetId) {
		if (id >= 50 && id <= 63)
			return id;
		switch (id) {
		case 0:
	...
	public void unlockEmote(final int id) {
	...
	public void useBookEmote(final int id) {
		...
		if (!unlockedEmotes.contains(id) && player.getRank().isMinimumRank(PlayerRank.ADMIN)) {
			if (id == 41) {
				player.getDialogueManager().startDialogue(
						SimpleMessage.class,
						"This emote can be acessed by unlocking "
								+ GameConstants.AIR_GUITAR_MUSICS_COUNT
								+ " pieces of music.");
			} else {
			...
			if (id == 2) {
				...
				player.getPackets().sendGameMessage(
						"This emote has not been added yet: Disappear.");
			} else if (id == 69) {// Ghost
				...
				player.getPackets().sendGameMessage(
						"This emote has not been added yet: Kneel.");
			} else if (id == 69) {// Begging
				player.getPackets().sendGameMessage(
						"This emote has not been added yet: Begging.");
			} else if (id == 70) {// Stir Cauldron
				player.getPackets().sendGameMessage(
						"This emote has not been added yet: Stir cauldron.");
			} else if (id == 71) {// Palm-fist
				player.setNextAnimation(new Animation(12931));
			} else if (id == 72) {// Tantrum
				player.getPackets().sendGameMessage(
						"This emote has not been added yet: Tantrum.");
			} else if (id == 73) {// Dramatic Death
				player.getPackets().sendGameMessage(
						"This emote has not been added yet: Dramatic death.");
			} else if (id == 74) {// Jump & Yell
				player.getPackets().sendGameMessage(
						"This emote has not been added yet: Jump & yell.");
			} else if (id == 77) {// Point
				player.getPackets().sendGameMessage(
						"This emote has not been added yet: Point.");
			} else if (id == 78) {// Punch
				player.getPackets().sendGameMessage(
						"This emote has not been added yet: Punch.");
			} else if (id == 79) {// Raise Hand
				player.getPackets().sendGameMessage(
						"This emote has not been added yet: Raise hand.");
			} else if (id == 80) {// Make Speach
				player.getPackets().sendGameMessage(
						"This emote has not been added yet: Make speach.");
			} else if (id == 81) {// Sword Fight
				player.getPackets().sendGameMessage(
						"This emote has not been added yet: Sword fight.");
			} else if (id == 82) {// Raise Hand (Sitting)
				player.getPackets().sendGameMessage(
						"This emote has not been added yet: Raise hand.");
			} else if (id == 83) {// Wave (Sitting)
				player.getPackets().sendGameMessage(
						"This emote has not been added yet: Wave sitting.");
			} else if (id == 84) {// Cheer (Sitting)
				player.getPackets().sendGameMessage(
						"This emote has not been added yet: Cheer sitting.");
			} else if (id == 85) {// Throw Tomato (Sitting)
				player.getPackets()
						.sendGameMessage(
								"This emote has not been added yet: Throw tomato sitting.");
			} else if (id == 86) {// Throw Flowers (Sitting)
				player.getPackets()
						.sendGameMessage(
								"This emote has not been added yet: Throw Flowers sitting.");
			} else if (id == 87) {// Agree (Sitting)
				player.getPackets().sendGameMessage(
						"This emote has not been added yet: Agree sitting.");
			} else if (id == 88) {// Point (Sitting)
				player.getPackets().sendGameMessage(
						"This emote has not been added yet: Point sitting.");
			} else if (id == 89) {// Whistle (Sitting)
				player.getPackets().sendGameMessage(
						"This emote has not been added yet: Whistle sitting.");
			} else if (id == 90) {// Thumbs-Up (Sitting)
				player.getPackets()
						.sendGameMessage(
								"This emote has not been added yet: Thumbs up sitting.");
			} else if (id == 91) {// Thumbs-Down (Sitting)
				player.getPackets()
						.sendGameMessage(
								"This emote has not been added yet: Thumbs down sitting.");
			} else if (id == 92) {// Clap (Sitting)
				player.getPackets().sendGameMessage(
						"This emote has not been added yet: Clap sitting.");
			} else if (id == 95) {// Living on borrowed time
				player.getPackets()
						.sendGameMessage(
								"This emote has not been added yet: Living on borrowed time.");
				...
				player.getPackets().sendGameMessage(
						"This emote has not been added yet: Break wind.");
				...
				player.getPackets()
						.sendGameMessage(
								"This emote has not been added yet: Frog transformation.");
				// player.setNextAnimation(new Animation(This emote has not been
				// added yet));
				// player.setNextGraphics(new Graphics(3220));
			} else if (id == 117) {// Mexican wave
				player.getPackets().sendGameMessage(
						"This emote has not been added yet: Mexican wave.");
			} else if (id == 118) {// Sportsman
				player.getPackets().sendGameMessage(
						"This emote has not been added yet: Sportsman.");
			} else if (id == 119) {// Sun bathe
				player.getPackets().sendGameMessage(
						"This emote has not been added yet: Sun bathe.");
				// player.setNextAnimation(new Animation(This emote has not been
				// added yet));
				// player.setNextGraphics(new Graphics(3256));

			} else if (id == 120) {// Kick sand
				player.getPackets().sendGameMessage(
						"This emote has not been added yet: Kick sand.");
				// player.setNextAnimation(new Animation(This emote has not been
				// added yet));
						...
						public void run() {
							if (step == 1) {
								player.getAppearance().transformIntoNPC(
										(rand == 0 ? 11227 : (rand == 1 ? 11227
												: 11227)));
								player.setNextAnimation(new Animation(
										((rand > 0 ? 13192 : (rand == 1 ? 13192
												: 13192)))));
							}
							if (step == 3) {
					...
					WorldTasksManager.schedule(new WorldTask() {
						...
						public void run() {
							...
							if (step == 2) {
								...
								dung3 = new NPC(-1, new WorldTile(
										player.getX(), player.getY() - 1,
										player.getPlane()), -1, true);
								dung4 = new NPC(-1, new WorldTile(
										player.getX(), player.getY() + 1,
										player.getPlane()), -1, true);
							}
							if (step == 3) {
				...
				case 24649:
					// Assasin Cape
					player.setNextAnimation(new Animation(17075));
				...
				case 20765:
					// Classic cape
					final int random = Utils.getRandom(2);
				...
				case 20767:
					// Max cape
					final int size = NPCDefinitions.getNPCDefinitions(1224).size;
			...
			if (id == 52) { // Seal Of Approval
				...
				player.setNextAnimation(new Animation(15535));
			} else if (id == 97) {
				player.setNextAnimation(new Animation(15532));
				player.setNextGraphics(new Graphics(2191));
			} else if (id == 98) {
				player.setNextAnimation(new Animation(15529));
				player.setNextGraphics(new Graphics(2197));
				...
				final NPC n = new NPC(14388, new WorldTile(player.getX(),
						player.getY() + 4, player.getPlane()), 0, false);
				n.setLocation(n);
	...
	public void setNextEmoteEnd(final long delay) {
