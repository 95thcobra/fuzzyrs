...
public class AncientEffigies {
	 ...
	 */
	public static int getRequiredLevel(final int id) {
		switch (id) {
	 ...
	 * @return message
	 */
	public static String getMessage(final int skill) {
		switch (skill) {
		case Skills.AGILITY:
	 ...
	 */
	public static int getExp(final int itemId) {
		switch (itemId) {
		case STARVED_ANCIENT_EFFIGY:
			return 15000;
		case NOURISHED_ANCIENT_EFFIGY:
	 ...
	 *            The effigy item id.
	 */
	public static void effigyInvestigation(final Player player, final int id) {
