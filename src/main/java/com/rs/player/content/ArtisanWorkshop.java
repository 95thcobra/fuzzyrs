...
public class ArtisanWorkshop {
	...
	public static void DepositIngots(final Player player) {
	...
	public static void DepositArmour(final Player player) {
		...
		player.getPackets().sendGameMessage(
				"You deposit all your armoury in Chute, long live dwarfs!");
	}

	public static void WithdrawIngots(final Player player) {
		player.getInventory().refresh();
	}
