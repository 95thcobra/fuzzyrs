...
import com.rs.game.player.DoomSayerButtons;
...
import com.rs.game.player.content.ClanChatManager;
...
public class ButtonHandler {
	...
	public static void handleButtons(final Player player, InputStream stream,
		...
		/*} else if (interfaceId == 583) {
			...
			if (componentId == 66) {
				if (DoomSayerButtons.getWildernessWall()) {
			...
			*/
			...
			case 12: // help
				...
				player.getPackets().sendIComponentText(275, 2,
						"Echo Information & Help");
				player.getPackets().sendIComponentText(275, 16,
						"Hello, and welcome to Echo 666.");
				player.getPackets()
						.sendIComponentText(275, 17,
								"If you require more advanced help, please contact a staff member.");
				player.getPackets().sendIComponentText(275, 18, "");
				player.getPackets().sendIComponentText(275, 19,
						"Commands can be found at: ::commands or ::cmd");
				player.getPackets().sendIComponentText(275, 20,
						"Found a bug? Report it for extra benefits!");
				player.getPackets()
						.sendIComponentText(275, 21,
								"Need some extra cash? Voting is a great way to get an extra 5M!");
				player.getPackets()
						.sendIComponentText(275, 22,
								"Don't know where to buy something? Use the Grand Exchange!");
				player.getPackets()
						.sendIComponentText(275, 23,
								"Lost? Don't have anything to do? View some guides on the forums!");
				player.getPackets()
						.sendIComponentText(275, 24,
								"Stuck or need immediate help? Contact a staff member!");
				player.getPackets().sendIComponentText(275, 25,
						"Is someone harrassing you? Please report them!");
				player.getPackets().sendIComponentText(275, 26, "");
...
//	public DoomSayerButtons DoomSayer;
