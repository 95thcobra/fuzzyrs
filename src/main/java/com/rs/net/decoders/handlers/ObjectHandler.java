...
public class ObjectHandler {
		...
		player.setCoordsEvent(new CoordsEvent(tile, new Runnable() {
			...
			public void run() {
				...
				if (hunterNpc != null) {
					...
					if (war != null && war.getStage() == Stage.STARTED)
						...
						player.getPackets().sendGameMessage(
								"You can't start a war at the moment.");
					//nex
				} else if (id == 57225) {
				...
				} else if (id == 16944 || id == 14082 || id == 12128)
				    FairyRings.openRingInterface(player, object, false);
				
				
			/*	if (LumbiTutorial.getStage(3)){
				if (id == 3042) {
				...
				if (id == 1) {
					...
					player.getActionManager().setSkill(
						...
						|| id == 3042 || id == 3027 || id == 3229 || id == 11936
			...
			/*	} else if (id == 30707 || id == 30708) {
				 ...
				 */
				 ...
				 else if (id == 57437 || id == 6084 || id == 22819 || id == 25808) 
				...
				if (player.getRights() == 2) {
					player.sm("First click - objectId: " + id
							+ ", at objectX: " + object.getX() + ", objectY: " + object.getY()
							+ ", " + object.getPlane());
				}
			}
		...
		player.setCoordsEvent(new CoordsEvent(tile, new Runnable() {
			...
			public void run() {
				...
				if (id == 36786 || id == 42378 || id == 42377 || id == 42217
						|| id == 27663 || id == 57437 || id == 6084 || id == 22819 || id == 25808)
					player.getBank().openBank();
				else if (object.getDefinitions().name
				...
				if (Settings.DEBUG)
					if (player.getRights() == 2) {
						player.sm("Second click - objectId: " + id
								+ ", at objectX: " + object.getX() + ", objectY: " + object.getY()
								+ ", " + object.getPlane());
					}
			}
	...
	public static void handleExamine(final Player player, InputStream stream) {
		...
		if (player.getRights() == 2) {
					player.sm("<col=00a0ff>examined object id : " + id
							+ ", at " + object.getX() + ", " + object.getY()
							+ ", " + object.getPlane());
		Logger.log("ObjectHandler", "examined object: " + id + ", x: " + x + ", y: " + y + "configid : " + object.getDefinitions().configFileId);
		}
	}
	...
	public static void handleOption3(final Player player, InputStream stream) {
		...
		player.setCoordsEvent(new CoordsEvent(tile, new Runnable() {
			...
			public void run() {
				...
				if (Settings.DEBUG)
					if (player.getRights() == 2) {
						player.sm("Third click - objectId: " + id
								+ ", at objectX: " + object.getX() + ", objectY: " + object.getY()
								+ ", " + object.getPlane());
				}
			}
		...
		player.setCoordsEvent(new CoordsEvent(tile, new Runnable() {
			...
			public void run() {
				...
				if (interfaceId == Inventory.INVENTORY_INTERFACE) { // inventory
					...
					} else if (itemId == 229 || itemId == 1923 || itemId == 1925 || itemId == 1935 
							|| itemId == 3734 || itemId == 5350 && object.getDefinitions().name.equals("Fountain") 
							|| object.getDefinitions().name.equals("Well") || object.getDefinitions().name.equals("Sink")) {
