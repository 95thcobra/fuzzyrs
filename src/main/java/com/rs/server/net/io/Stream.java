...
public abstract class Stream {
	...
	public final void decodeXTEA(final int keys[], final int start,
			final int end) {
		final int l = offset;
		offset = start;
		final int i1 = (end - start) / 8;
	...
	public final void getBytes(final byte data[], final int off, final int len) {
