...
import com.rs.game.player.dialogues.falador.Wizard;
...
import com.rs.game.player.dialogues.varrock.Horvik;
import com.rs.game.player.dialogues.varrock.Lowe;
import com.rs.game.player.dialogues.ChristmasCrackerD;
import com.rs.game.player.dialogues.NexEntrance;
import com.rs.game.player.dialogues.PartyRoomLever;
import com.rs.game.player.dialogues.CompCape;
...
public final class DialogueHandler {
	...
	public static final void init() {
		try {
			...
			handledDialogues.put("Hairdresser", value73);

			Class<Dialogue> value74 = (Class<Dialogue>) Class
					.forName(Wizard.class.getCanonicalName());
			handledDialogues.put("Wizard", value74);

			Class<Dialogue> value75 = (Class<Dialogue>) Class
					.forName(QuestHolder.class.getCanonicalName());
			handledDialogues.put("QuestHolder", value75);

			Class<Dialogue> value76 = (Class<Dialogue>) Class
					.forName(Ariane.class.getCanonicalName());
			handledDialogues.put("Ariane", value76);

			Class<Dialogue> value77 = (Class<Dialogue>) Class
					.forName(MiningInstructor.class.getCanonicalName());
			handledDialogues.put("MiningInstructor", value77);

			Class<Dialogue> value78 = (Class<Dialogue>) Class
					.forName(CrateTutorial.class.getCanonicalName());
			handledDialogues.put("CrateTutorial", value78);

			Class<Dialogue> value80 = (Class<Dialogue>) Class
					.forName(KingRoald.class.getCanonicalName());
			handledDialogues.put("KingRoald", value80);
			//			Class<Dialogue> value81 = (Class<Dialogue>) Class
			//					.forName(KingRoaldTest.class.getCanonicalName());
			//			handledDialogues.put("KingRoaldTest", value81);
			/*Class<Dialogue> value82 = (Class<Dialogue>) Class
					.forName(PriestinPerilTemple.class.getCanonicalName());
			handledDialogues.put("PriestinPerilTemple", value82);*/
			/**
			 * @author Gircat <gircat101@gmail.com> 
			 */
			Class<Dialogue> value502 = (Class<Dialogue>) Class //ChristmasCrackerD
					.forName(ChristmasCrackerD.class.getCanonicalName()); //ChristmasCrackerD

			Class<Dialogue> value81 = (Class<Dialogue>) Class
					.forName(Aubury.class.getCanonicalName());
			handledDialogues.put("Aubury", value81);
			Class<Dialogue> value82 = (Class<Dialogue>) Class
					.forName(CompCape.class.getCanonicalName());
			handledDialogues.put("CompCape", value82);
			Class<Dialogue> value83 = (Class<Dialogue>) Class
					.forName(Lowe.class.getCanonicalName());
			handledDialogues.put("Lowe", value83);
			Class<Dialogue> value84 = (Class<Dialogue>) Class
					.forName(Horvik.class.getCanonicalName());
			handledDialogues.put("Horvik", value84);
			Class<Dialogue> value13727 = (Class<Dialogue>) Class
					.forName(Xuan.class.getCanonicalName());
			handledDialogues.put("Xuan", value13727);
