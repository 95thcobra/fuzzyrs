...
*/
	...
	public static void spawnRandomNpc(int id, WorldTile[] Location,
			int mapAreaNameHash, boolean canBeAttackFromOutOfArea) {
	spawnRandomNpc(id, Location, mapAreaNameHash, canBeAttackFromOutOfArea);
		
	}

	public static ConcurrentHashMap<Integer, int[]> getStaffOnline() {
