...
public class NPC extends Entity implements Serializable {
	...
	public void sendDrop(Player player, Drop drop) {
		...
		if (getId() == 6246 || getId() == 6236 || getId() == 6232
				|| getId() == 6240 || getId() == 6241 || getId() == 6242
				|| getId() == 6235 || getId() == 6234 || getId() == 6243
				|| getId() == 6236 || getId() == 6244 || getId() == 6237
				|| getId() == 6246 || getId() == 6238 || getId() == 6239
				|| getId() == 6230) {
			player.ArmadylKC = +1;
		}
		if (getId() == 6281 || getId() == 6282 || getId() == 6275
				|| getId() == 6279 || getId() == 9184 || getId() == 6268
				|| getId() == 6270 || getId() == 6274 || getId() == 6277
				|| getId() == 6276 || getId() == 6278 || getId() == 6213
				|| getId() == 6271) {
			player.BandosKC = +1;
		}
