...
public enum QueenState {
    ...
    CRYSTAL_ARMOUR(
            15506,
            "<col=66FFFF>The Queen Black Dragon takes the consistency of crystal; she is more resistant to</col>(nl)<col=66FFFF>magic, but weaker to physical damage.</col>"),
    ...
    HARDEN(
            15507,
            "<col=669900>The Queen Black Dragon hardens her carapace; she is more resistant to physical</col>(nl)<col=669900>damage, but more vulerable to magic.</col>");
     ...
     */
    QueenState(final int npcId, final String message) {
        this.npcId = npcId;
