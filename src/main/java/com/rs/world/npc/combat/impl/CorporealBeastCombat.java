...
public class CorporealBeastCombat extends CombatScript {
    ...
    public int attack(final NPC npc, final Entity target) {
        ...
        if (Utils.getRandom(40) == 0) {
            final CorporealBeast beast = (CorporealBeast) npc;
        ...
        for (final Entity t : possibleTargets) {
            final int distanceX = t.getX() - npc.getX();
            final int distanceY = t.getY() - npc.getY();
        ...
        if (attackStyle == 2) { // powerfull mage spiky ball
            ...
            CombatScript.delayHit(
                    ...
                    CombatScript.getMagicHit(
                            npc,
                            CombatScript.getRandomMaxHit(npc, 650,
                    ...
                    for (int i = 0; i < 6; i++) {
                        ...
                        for (final Entity t : possibleTargets) {
                            ...
                            CombatScript.delayHit(
                                    ...
                                    CombatScript.getMagicHit(
                                            npc,
                                            CombatScript.getRandomMaxHit(npc, 350,
