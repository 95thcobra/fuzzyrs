...
public class BlinkCombat extends CombatScript {
    ...
    private void attackSounds(final NPC npc) {
        switch (Utils.random(5)) {
            ...
            case 1:
                ...
                break;
            case 2:
                npc.setNextForceTalk(new ForceTalk("A whole new worldtask!"));
        ...
        WorldTasksManager.schedule(new WorldTask() {
            ...
            public void run() {
                ...
                for (final Entity t : npc.getPossibleTargets()) {
                    ...
                    CombatScript.delayHit(npc, 1, t, new Hit(npc, Utils.random(100, 850),
    ...
    public int attack(final NPC npc, final Entity target) {
            ...
            WorldTasksManager.schedule(new WorldTask() {
                ...
                public void run() {
                    ...
                    for (final Entity t : npc.getPossibleTargets()) {
                        ...
                        CombatScript.delayHit(npc, 1, t, new Hit(npc, Utils.random(150),
                                Hit.HitLook.MAGIC_DAMAGE));
                        t.setNextGraphics(new Graphics(2855, 0, 0));
                    }
		 ...
		 * npc.playSound(2989, 2); WorldTasksManager.scheduleTask(new WorldTask() {
		 *
