...
public final class Nex extends NPC {
    ...
    public Nex(final int id, final WorldTile tile, final int mapAreaNameHash,
    ...
    public ArrayList<Entity> calculatePossibleTargets(final WorldTile current,
                                                      final WorldTile position, final boolean northSouth) {
    ...
    public void handleIngoingHit(final Hit hit) {
        ...
        if (getId() == 13449 && hit.getLook() == HitLook.MELEE_DAMAGE) {
            ...
            if (source != null) {
                final int deflectedDamage = (int) (hit.getDamage() * 0.1);
    ...
    @Override
    public void setNextGraphics(final Graphics nextGraphic) {
        if (doingSiphon)
            return;
    ...
    public void setFollowTarget(final boolean followTarget) {
    ...
    public void setFlyTime(final int flyTime) {
    ...
    public void setLastVirus(final long lastVirus) {
        this.lastVirus = lastVirus;
    }

    public void sendVirusAttack(final ArrayList<Entity> hitedEntitys,
                                final ArrayList<Entity> possibleTargets, final Entity infected) {
    ...
    public void setEmbracedShadow(final boolean embracedShadow) {
    ...
    public void setTrapsSettedUp(final boolean trapsSettedUp) {
    ...
    public void setLastSiphon(final long lastSiphon) {
    ...
    public void killBloodReavers() {
        for (int index = 0; index < bloodReavers.length; index++) {
            ...
            final NPC npc = bloodReavers[index];
    ...
    public void setDoingSiphon(final boolean doingSiphon) {
