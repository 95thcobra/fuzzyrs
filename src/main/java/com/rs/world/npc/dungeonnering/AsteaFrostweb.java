...
/*
 * package com.rs.gametask.npc.dungeonnering;
 * 
 * import Entity; import Hit; import
 * Hit.HitLook; import World; import
 * WorldTile; import NPC; import
 * Player; import
 * Dungeon; import
 * DungeonManager; import
 * RoomReference;
 * 
 ...
 * 
 * public void switchPrayers() { transformIntoNPC(getMessageIcon() == meleeNPCId + 2 ?
 * meleeNPCId : getMessageIcon() + 1); }
 * 
 ...
 * super.handleIngoingHit(hit); if (getMessageIcon() == meleeNPCId) { if (hit.getLook()
 * == HitLook.MELEE_DAMAGE) hit.setDamage(0); } else if (getMessageIcon() == meleeNPCId +
