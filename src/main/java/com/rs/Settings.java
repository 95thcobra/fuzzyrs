...
public final class Settings {
	...
	public static final String[] PROFANITY_WORDS = new String[] { "cunt", "nigger",
		"paki", "nig", "fuck", "shit", "bell", "gay", "fagget", "faggot", "fudgepacker", "cock", "fanny", "queer", "coon",
		"nigga", "anal", "sex", "penetration", "gape", "sucker", "prick", "dick", "poof" };

	public static boolean DEBUG;
	public static boolean HOSTED;

	// Server Connection Settings
	public static final String SERVER_NAME = "Adrastos";
...
//	public static final String START_CONTROLER = "NewHomeControler"; //ControlerManager
	public static final WorldTile START_PLAYER_LOCATION = new WorldTile(2965, 3370, 0);
//	public static final WorldTile START_PLAYER_LOCATION = new WorldTile(3080, 9507, 0);
	public static final WorldTile RESPAWN_PLAYER_LOCATION = new WorldTile(2965, 3370, 0);
	...
	public static final int XP_RATE = 45;
